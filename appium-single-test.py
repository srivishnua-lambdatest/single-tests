...
username = "srivishnua" # Replace the username
access_key = "lRPrFiIHat1GfMOOMISoBEcyPoa9XsABtLjAGw4flFgW2PjG1P" # Replace the access key
...
class FirstSampleTest(unittest.TestCase):
    ...
    def setUp(self):
        desired_caps = {
            ...
            "platformName": 'android', # Change your OS version here
            "deviceName": 'Galaxy A8', # Change your browser here
            "platformVersion": '7.1', # Change your os version here
